...
class _SettingsScreenState extends State<SettingsScreen> {
          ...
          SafeArea(
            child: ListView(
              ...
              children: [
                ...
                _buildSettingsCard(
                  children: [
                    _buildFeatureTile('Konversi Basis Logika', Icons.code_rounded, Colors.greenAccent, BaseConverterScreen(), isVipOnly: true),
                    _buildFeatureTile('Kriptografi & Sandi', Icons.security_rounded, Colors.redAccent, CipherScreen(), isVipOnly: true),
                    _buildFeatureTile('Konversi Mata Uang', Icons.monetization_on_rounded, Colors.orangeAccent, CurrencyScreen(), isVipOnly: false),
                    _buildFeatureTile('Kalkulator Kesehatan (BMI)', Icons.favorite_rounded, Colors.pinkAccent, HealthCalculatorScreen(), isVipOnly: false),
                    _buildFeatureTile('Split Bill (Patungan)', Icons.receipt_long_rounded, Colors.blueAccent, SplitBillScreen(), isVipOnly: false),
                    _buildFeatureTile('Matriks Waktu', Icons.access_time_rounded, Colors.purpleAccent, TimeMatrixScreen(), isVipOnly: false),
                    _buildFeatureTile('Konversi Satuan Umum', Icons.straighten_rounded, Colors.cyanAccent, UnitScreen(), isVipOnly: false),
                  ],
                ),
  ...
  Widget _buildFeatureTile(String title, IconData icon, Color iconColor, Widget destinationScreen, {bool isVipOnly = false}) {
    return Column(
      children: [
        ListTile(
          leading: Container(
          ...
          trailing: Icon(
            (isVipOnly && !_isVip) ? Icons.lock_outline_rounded : Icons.chevron_right_rounded,
            color: (isVipOnly && !_isVip) ? Colors.amber.withOpacity(0.5) : AppColors.numberText.withOpacity(0.38),
            size: (isVipOnly && !_isVip) ? 20 : 24,
          ),
          onTap: () {
            if (isVipOnly && !_isVip) {
              ScaffoldMessenger.of(context).showSnackBar(
        ...
        Divider(color: AppColors.numberText.withOpacity(0.05), height: 1),
      ],
    );
  }
